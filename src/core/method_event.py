...
def main():
    ...
    # The add_liquidity method mints the LP tokens in the 2nd event of the contract.
    # The contract that orchestrates this event is the Curve LP Base Contract with
    # the address 0xcA3d75aC011BF5aD07a98d02f18225F9bD9A6BDF . The method used is
    # Transfer()
